// Command attribute_index is a command-line interface for testing the attribute
// embedding index.
// It prints the names of the 20 most similar datasets to the query attribute.
// chem
package main
